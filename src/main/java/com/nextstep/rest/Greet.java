...
public class Greet {
	...
	public ResponseEntity<String> greet() {
		...
		return new ResponseEntity<>(" Good morning  ............1", HttpStatus.OK);
	}
	...
	public ResponseEntity<byte[]> generateProductPdf() {
	    ...
	    try {
	        ...
	        Paragraph footer = new Paragraph(
	                "Thank you for your purchase!", footerFont);
	        ...
	        return ResponseEntity.ok()
	                .header(HttpHeaders.CONTENT_DISPOSITION, "inline; filename=product-invoice.pdf")
